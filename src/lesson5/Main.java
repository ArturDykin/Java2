...
public class Main {
    ...
    public void runOneThread() {
        ...
        calculate(arr);
        System.out.println("Однопоточный заканчивается на: " + (System.currentTimeMillis() - a));
    }
    ...
    public void runTwoThreads() {
        ...
        System.out.println("Двухпоточный заканчиваются на: " + (System.currentTimeMillis() - a));
    }
